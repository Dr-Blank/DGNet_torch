...
if __name__ == '__main__':
    ...
    if opt.model == 'DGNet':
        ...
        model = DGNet(channel=32, arc='EfficientNet-B1', M=[8, 8, 8], N=[8, 16, 32]).cuda()
    elif opt.model == 'DGNet-PVTv2-B0':
        model = DGNet(channel=32, arc='PVTv2-B0', M=[8, 8, 8], N=[8, 16, 32]).cuda()
    elif opt.model == 'DGNet-PVTv2-B1':
        model = DGNet(channel=64, arc='PVTv2-B1', M=[8, 8, 8], N=[4, 8, 16]).cuda()   
    elif opt.model == 'DGNet-PVTv2-B2':
        model = DGNet(channel=64, arc='PVTv2-B2', M=[8, 8, 8], N=[4, 8, 16]).cuda()
    elif opt.model == 'DGNet-PVTv2-B3':
        model = DGNet(channel=64, arc='PVTv2-B3', M=[8, 8, 8], N=[4, 8, 16]).cuda()   
    elif opt.model == 'DGNet-PVTv2-B4':
        model = DGNet(channel=64, arc='PVTv2-B4', M=[8, 8, 8], N=[4, 8, 16]).cuda()
    else:
